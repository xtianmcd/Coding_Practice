...
"""
this code is originally from Milo Spencer-Harper's Medium article titled "How
to build a multi-layered neural network in Python"
"""
...
class NeuralNetwork():
    ...
    # The Sigmoid function, which discribes an S shaped curve.
    ...
    def train(self, training_set_inputs, training_outputs, number_of_epochs):
        for iteration in range(number_of_epochs):
            # Pass the training set through our neural network
            output_from_layer_1, output_from_layer_2 = self.think(training_set_inputs)

            # Calculate the error for layer 2 (The difference between the
            ...
            # layer 1, we can determine by how much layer 1 contributed to the
            # error in layer 2).
    ...
    # The neural network prints its synaptic_weights
...
if __name__ == "__main__":
    ...
    neural_network.train(training_set_inputs, training_outputs, 100000)
